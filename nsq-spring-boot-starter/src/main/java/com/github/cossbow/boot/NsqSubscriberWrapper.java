...
class NsqSubscriberWrapper implements NsqSubscriber {
    private static final Logger log = LoggerFactory.getLogger(NsqSubscriberWrapper.class);
    ...
    private long defaultBatchInterval;
